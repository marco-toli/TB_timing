...
G4Material* MyMaterials::YAG_Ce()
{
  ...
  G4double Absorption[nEntries_ABS] =
    ...
    129.476*mm, 226.564*mm, 553.51*mm, 516.632*mm, 1548.01*mm, 790.713*mm, 1385.84*mm, 1400.2*mm, 
    2096.9*mm, 1670.1*mm, 2186.03*mm, 2287.12*mm, 1954.48*mm, 2354.49*mm, 1918.87*mm, 2109.46*mm, 
    2078.54*mm, 2401.69*mm, 2489.04*mm, 2011.43*mm, 2610.2*mm, 2575.31*mm, 1409.36*mm, 1516.1*mm, 
    1821.39*mm, 2404.6*mm, 1809.72*mm, 2095.23*mm, 2242.87*mm, 2220.69*mm, 1176.59*mm, 2541.71*mm, 
    1849.6*mm, 2197.28*mm, 1914.57*mm, 1747.84*mm};
...
G4Material* MyMaterials::LSO()
{
  ...
  G4double PhotonEnergy_ABS[nEntries_ABS] =
    { 4.42857*eV, 4.35088*eV, 4.27586*eV, 4.20339*eV, 4.13333*eV, 4.06557*eV, 4*eV, 3.93651*eV, 3.875*eV, 3.81538*eV, 
      ...
      1.90769*eV, 1.89313*eV, 1.87879*eV, 1.86466*eV, 1.85075*eV, 1.83704*eV, 1.82353*eV, 1.81022*eV, 1.7971*eV, 1.78417*eV
    };
      
  G4double Absorption[nEntries_ABS] =
    { 0*mm, 0.*mm, 0.*mm, 0.*mm, 0.*mm, 0.*mm, 0.*mm, 0.*mm, 0.*mm, 
      1.*mm, 1.*mm, 1.*mm, 1.*mm, 1.8777*mm, 1.87553*mm, 1.86245*mm, 1.87864*mm, 1.89938*mm,
      1.90652*mm, 1.93828*mm, 1.92292*mm, 3.19852*mm, 7.84337*mm, 19.4627*mm, 43.2508*mm, 90.9185*mm, 161.725*mm, 
      ...
      500.801*mm, 500.457*mm, 500.729*mm
    };
  ...
  myMPT->AddConstProperty("FASTTIMECONSTANT", 40.*ns);
  myMPT->AddConstProperty("FASTSCINTILLATIONRISETIME", 0.07*ns);
  myMPT->AddConstProperty("YIELDRATIO", 1.0);
